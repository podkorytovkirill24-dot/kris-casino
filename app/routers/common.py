...
async def menu_support(callback: CallbackQuery, state: FSMContext, config: Config) -> None:
    await state.clear()
...
async def menu_withdraw(callback: CallbackQuery, state: FSMContext, config: Config) -> None:
    await state.clear()
...
async def menu_admin(callback: CallbackQuery, state: FSMContext, config: Config) -> None:
    await state.clear()
